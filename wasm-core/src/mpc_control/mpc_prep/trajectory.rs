...
fn quadratic_xy_derivatives(
    ...
    let first = quadratic_first_derivative(args.0, args.1, args.2, args.3, args.4, args.5, target_u);
    let second = quadratic_second_derivative(args.0, args.1, args.2, args.3, args.4, args.5);
    (first, second)
}
