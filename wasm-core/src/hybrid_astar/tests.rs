...
mod tests {
    ...
    fn planner_returns_success_result_in_empty_box() {
        ...
        let mut planner =
            HybridAStarPlanner::new(2.0, 2.0, 0.0, 15.0, 15.0, 0.0, obstacles, 4000)
                .expect("path");
    ...
    fn unreachable_search_returns_finished_empty_result() {
        ...
        let mut planner =
            HybridAStarPlanner::new(2.0, 2.0, 0.0, 10.0, 2.0, 0.0, obstacles, 4000)
                .expect("planner");
        while !planner.step(256).expect("step") {}
    ...
    fn point_start_collision_keeps_first_escape_rollout() {
        ...
        let planner =
            HybridAStarPlanner::new(2.0, 2.0, 0.0, 15.0, 15.0, 0.0, obstacles, 1)
                .expect("planner");
    ...
    fn neighbour_acceptance_does_not_prune_blocked_heuristic_cells() {
        ...
        let neighbour =
            generate_neighbour(&current, 1, 0.0, &goal, &config, &heuristic, &obstacles, false);
